...
- D7pay APK 当前文件名为 `d7pay_merchant_arm64_v0.1.6_202605031740.apk`，内置 `API_BASE_URL=https://api.d7pay.net`。
...
8. 服务器仓库可以更新到最新 `origin/d7pay`，但更新代码不等于部署 D7pay；部署必须通过 `ops/tenants/d7pay/jenkins/deploy-d7pay.sh`。
