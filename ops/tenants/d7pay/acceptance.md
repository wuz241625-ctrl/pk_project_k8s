...
- apkdownload 构建使用 `npm run build:d7pay`，页面读取 `d7pay_merchant` 元信息并指向 `d7pay_merchant_arm64_v0.1.6_202605031740.apk`。
...
- `apkdownload` 使用 `npm run build:d7pay` 构建通过，产物包含 `/files/android/d7pay/d7pay_merchant_arm64_v0.1.6_202605031740.apk`。
...
- D7pay APK 链接 `https://apkdownload.d7pay.net/files/android/d7pay/d7pay_merchant_arm64_v0.1.6_202605031740.apk` 返回 `200`，APK 内置 `API_BASE_URL=https://api.d7pay.net`。
