...
class EasyPaisaRuntimeRolloutCleanupTests(unittest.TestCase):
    def setUp(self):
        ...
        self.redis.set("easypaisa_runtime:health_pause:order:533280", "api_error")
        ...
        self.redis.sadd("easypaisa_runtime:index:collect_enabled", 533280)
        self.redis.sadd("easypaisa_runtime:index:df_order_enabled", 533280)
        self.redis.sadd("easypaisa_runtime:index:ds_order_enabled", 533280)
        self.redis.sadd("easypaisa_runtime:index:dispatch_df", 533280)
        self.redis.sadd("easypaisa_runtime:index:dispatch_ds", 533280)
        self.redis.zadd("easypaisa_runtime:schedule:collection", {533280: 1744000000})
    ...
    def test_collect_cleanup_plan_only_targets_easypaisa_state(self):
        ...
        self.assertEqual(plan["matched_keys"], [
            "easypaisa_runtime:health_pause:order:533280",
        ...
        self.assertEqual(plan["runtime_collect_payment_ids"], ["533280"])
        self.assertEqual(plan["runtime_df_order_payment_ids"], ["533280"])
        self.assertEqual(plan["runtime_ds_order_payment_ids"], ["533280"])
    ...
    def test_execute_cleanup_removes_only_targeted_easypaisa_state(self):
        ...
        self.assertEqual(result["deleted_keys"], 6)
        ...
        self.assertEqual(result["removed_runtime_collect"], 1)
        self.assertEqual(result["removed_runtime_df_order"], 1)
        self.assertEqual(result["removed_runtime_ds_order"], 1)
        ...
        self.assertIsNone(self.redis.get("easypaisa_runtime:health_pause:order:533280"))
        ...
        self.assertEqual(self.redis.smembers("easypaisa_runtime:index:collect_enabled"), set())
        self.assertEqual(self.redis.smembers("easypaisa_runtime:index:df_order_enabled"), set())
        self.assertEqual(self.redis.smembers("easypaisa_runtime:index:ds_order_enabled"), set())
