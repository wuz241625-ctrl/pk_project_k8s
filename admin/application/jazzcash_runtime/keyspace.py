...
SNAPSHOT_KEY = "jazzcash_runtime:snapshot:{payment_id}"
SESSION_KEY = "jazzcash_runtime:session:{payment_id}"
LOCK_PAYMENT_KEY = "jazzcash_runtime:lock:payment:{payment_id}"
LOCK_PHONE_KEY = "jazzcash_runtime:lock:phone:{phone}"
KICKOFF_KEY = "jazzcash_runtime:kickoff:{payment_id}"
PRE_LOGIN_KEY = "pre_login_jazzcash_{payment_id}"

INDEX_ONLINE = "jazzcash_runtime:index:online"
INDEX_COLLECT_ENABLED = "jazzcash_runtime:index:collect_enabled"
INDEX_DS_ORDER_ENABLED = "jazzcash_runtime:index:ds_order_enabled"
INDEX_DF_ORDER_ENABLED = "jazzcash_runtime:index:df_order_enabled"
INDEX_DISPATCH_DF = "jazzcash_runtime:index:dispatch_df"
INDEX_DISPATCH_DS = "jazzcash_runtime:index:dispatch_ds"
INDEX_UPDATED_AT = "jazzcash_runtime:index:updated_at"
...
LEGACY_LOGIN_ON_PAYMENT = "login_on_jazzcash_{payment_id}"
LEGACY_LOGIN_ON_PHONE = "login_on_jazzcash_{phone}"
LEGACY_KICKOFF = "kick_off_{payment_id}"
JOB_HASH = "hash_jazzcash"
JOB_SET = "set_jazzcash"
SCHEDULE_COLLECTION = "jazzcash_runtime:schedule:collection"
