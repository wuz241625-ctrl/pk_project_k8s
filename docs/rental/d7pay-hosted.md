...
- D7pay APK：`apkdownload/public/files/android/d7pay/d7pay_merchant_arm64_v0.1.6_202605031740.apk`
...
本轮要求 arm64 瘦身包 `d7pay_merchant_arm64_v0.1.6_202605031740.apk` 通过 `aapt dump badging` 验证：
