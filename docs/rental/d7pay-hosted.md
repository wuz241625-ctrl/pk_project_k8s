...
- D7pay ARM64 APK：`apkdownload/public/files/android/d7pay/d7pay_merchant_arm64_v0.1.7_202605031803.apk`
- D7pay ARM APK：`apkdownload/public/files/android/d7pay/d7pay_merchant_arm_v0.1.7_202605031803.apk`
...
本轮要求 ARM64 瘦身包 `d7pay_merchant_arm64_v0.1.7_202605031803.apk` 和 ARM 瘦身包 `d7pay_merchant_arm_v0.1.7_202605031803.apk` 通过 `aapt dump badging` 与 `apksigner verify` 验证：
